...
// GIN/OHM changes: change position transforms to align to left of screen, not center
// not sure why, but for us the values always come up to 229 (238 with a border) so let's just go with that
offsetX = $(window).width() < 768 ? 0 : 238;
